...
class FunkSVD(FunkSVDScorer):
    ...
    def get_default_configspace(hyperopt = False, **kwargs):
        ...
        if hyperopt:
            cs = {
                "algo": "FunkSVD",
                "FunkSVD:features": hp.uniformint("FunkSVD:features", 2, 10000),
                "FunkSVD:lrate": hp.uniform("FunkSVD:lrate", 0.0001, 0.01),
                "FunkSVD:reg": hp.uniform("FunkSVD:reg", 0.001, 0.1),
                "FunkSVD:damping": hp.uniform("FunkSVD:damping", 0.01, 1000),
            }
