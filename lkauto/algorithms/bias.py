...
class Bias(BiasScorer):
    ...
    def get_default_configspace(number_item: int, number_user: int, hyperopt = False):
        ...
        if hyperopt:
            cs = {
                "algo": "Bias",
                "Bias:item_damping": hp.uniform("Bias:item_damping", 1e-5*number_item, 85*number_item),
                "Bias:user_damping": hp.uniform("Bias:user_damping", 1e-5*number_user, 85*number_user),
            }
